...
/**
 * <p>Title:UserDetailesImpl用户细节模型</p>
 * <p>Description:</p>
 * <p>Company:</p>
 * @author jackhoo
...
public class UserDetailesImpl implements UserDetails, CredentialsContainer,Cloneable{
    ...
    public int hashCode()
    {
	 ...
	 @Override
	    ...
	    {
	        return other instanceof UserDetailesImpl &&
	                ((UserDetailesImpl)other).username == this.username;
	    }

	@Override
	public String toString() {
		return "UserDetailesImpl [username=" + username + ", password=" + password + ", authorities=" + authorities
				+ ", accountNonExpired=" + enabled + ", accountNonLocked=" + enabled
				+ ", credentialsNonExpired=" + enabled + ", enabled=" + enabled + "]";
	}
